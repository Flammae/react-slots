...
`useControlledState` hook. There are many implementations of this hook, one of
...
type ListItemProps = {
	children: SlotChildren<
		...
		| Slot<{ isExpanded: boolean }> // Shorthand of Slot<"default", {}>
	>,
	isExpanded: boolean,
...
These components don't assume any specific shape of data and work with
